<template>
	<main>
		...
		<div class="divide tooltip-showcase">
			<p v-tooltip.top tooltip="This is a top tooltip!">Top tooltip (hover me)</p>
			<p v-tooltip.bottom tooltip="This is a bottom tooltip!">Bottom tooltip (hover me)</p>
			<p v-tooltip.right tooltip="This is a right tooltip!" style="margin-right: 1rem;">Right tooltip (hover me)</p>
			<p v-tooltip.left tooltip="This is a left tooltip!">Left tooltip (hover me)</p>
		</div>
